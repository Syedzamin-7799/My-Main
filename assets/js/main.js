...
document.addEventListener('DOMContentLoaded', function () {
  ...
  form.addEventListener('submit', function (e) {
    ...
    if (!name || name.length < 3) {
      document.getElementById('name').textContent = 'Name - Invalid';
      isValid = false;
    } else {
    ...
    if (!emailRegex.test(email)) {
      document.getElementById('email').textContent = 'Mail - Invalid';
      isValid = false;
    } else {
    ...
    if (!message || message.length < 10) {
      document.getElementById('Message').textContent = 'Message - Invalid';
      isValid = false;
    } else {
